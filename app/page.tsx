    ...
    <main className="relative min-h-screen concrete-bg text-white selection:bg-primary selection:text-black overflow-x-hidden">
        ...
        <section className="py-32 px-6 bg-black">
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
            {/* Item 1 */}
            <m.div {...fadeInUp} className="group relative">
              ...
              <div className="mt-6 flex justify-between items-end">
                ...
                <div aria-hidden="true" className="text-white/20 text-6xl font-black italic">01</div>
              </div>
            </m.div>
            ...
            >
              ...
              <div className="mt-6 flex justify-between items-end text-right md:text-left">
                 <div aria-hidden="true" className="order-2 md:order-1 text-white/20 text-6xl font-black italic">02</div>
        ...
        <section className="py-32 bg-white text-black">
          <div className="px-6 md:px-12">
            <m.h2 {...fadeInUp} className="text-7xl md:text-9xl font-black uppercase tracking-tighter mb-20 italic">EXPERTISE</m.h2>
        ...
        <section className="py-40 px-6 bg-black flex flex-col items-center">
          <m.h2 {...fadeInUp} className="text-7xl md:text-[10rem] font-black text-outline-white uppercase mb-20 italic text-center">PAY FOR QUALITY</m.h2>
              ...
              >
                ...
                <ul className="space-y-4 mb-12">
                  {tier.features.map((f, j) => (
                    <li key={j} className={`flex items-center gap-3 font-bold uppercase ${tier.highlight ? "text-black" : f.active ? "text-white" : "text-gray-400"}`}>
                      <span className={tier.highlight ? "" : f.active ? "text-primary" : "text-gray-500"}>{f.active ? "✓" : "X"}</span> {f.label}
                    </li>
                  ))}
                </ul>
        ...
        <section className="py-60 px-6 text-center relative overflow-hidden bg-black border-t-8 border-primary">
          ...
          <div className="max-w-5xl mx-auto chaotic-layer">
            ...
            <m.div {...fadeInUp} transition={{ delay: 0.3 }}>
              <Link href="/contact">
